...
class ListIterator extends Base{
	...
	function next(){
		$this->_index ++;
		$this->valid = (FALSE !== next($this->_values)); 
	}
	...
	{
		$this->_index --;
		$this->valid = (FALSE !== prev($this->_values)); 
	}
	//+----------------------------------------
	//|	移动到开始位置
	//+----------------------------------------
	function rewind(){
		$this->_index = 0;
		$this->valid = (FALSE !== reset($this->_values)); 
	}
	...
	function end(){
		...
		$this->valid = (FALSE !== end($this->_values)); 
	}
