 ...
 * @version    $Id: AdminAction.class.php 101 2006-11-14 06:23:38Z fcs $
 +------------------------------------------------------------------------------
 */
    ...
    function _initialize() 
    {
        if(Session::is_set(USER_AUTH_KEY)) {
            ...
            if(Session::is_set('menu'.Session::get(USER_AUTH_KEY))) {
                ...
                import('@.Dao.NodeDao');
                $dao    =   new NodeDao();
                $list   =   $dao->findAll('level=2 and parentId='.getAppId(),'','id,name,title','seqNo asc');  
