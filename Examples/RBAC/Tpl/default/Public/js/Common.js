...
function sortBy (field,sort,func,other){
	location.href = URL+"/"+func+"/order/"+field+"/sort/"+sort+"/"+other;
}
...
function editpage(id){
	...
	location.href =  APP+"/page/edit/t/type/id/"+keyValue;
}
...
function page(id){
	...
	location.href =  APP+"/userpage/edit/id/"+keyValue;
}
...
function del(id){
	...
	{
		window.location=URL+"/delete/id/"+keyValue;
	}
}
function doDelete(){
		var Table = $('checkList');
