...
define('TMPL_CACHE_TIME',1);	//静态页面有效时间 -1 为永久
define('HTML_CACHE_TIME',1);	//静态页面有效时间 -1 为永久
...
define('TMPL_L_DELIM','{');
define('TMPL_R_DELIM','}');
define('WAITING_TIME_ERROR','3');
define('WAITING_TIME_OK','1');
define('CLOSE_WINDOW_TIME','5');
//+----------------------------------------
//|	调试和Log设置
//+----------------------------------------
