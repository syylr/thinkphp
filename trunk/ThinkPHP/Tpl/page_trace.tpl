<div id="think_page_trace" style="position: fixed;bottom:0;right:0;font-size:14px;width:100%;z-index: 999999;color: #000;text-align:left;">
    <div id="think_page_trace_tab" style="display: none;background:white;margin:0;height: 250px;">
        ...
        <div id="think_page_trace_tab_cont" style="overflow:auto;height:200px;padding: 6px 12px; line-height: 22px">
...
<div id="think_page_trace_open" style="text-align: right;overflow:hidden;position:fixed;bottom:0;right:0;color:#000;"><img width="30" style="cursor:pointer;background:#fff;border-radius:5px 0 0;" title="ShowPageTrace" src="data:image/png;base64,<?php echo App::logo() ?>"></div>
<script type="text/javascript">
(function(){
    var tab_tit  = document.getElementById('think_page_trace_tab_tit').getElementsByTagName('span');
    var tab_cont = document.getElementById('think_page_trace_tab_cont').getElementsByTagName('div');
	var open     = document.getElementById('think_page_trace_open').childNodes[0];
	...
	close.onclick = function(){
        ...
        this.parentNode.style.display = 'none';
		open.parentNode.style.display = 'block';
		history[0] = 0;
		document.cookie = 'thinkphp_show_page_trace='+history.join('|')
	}
