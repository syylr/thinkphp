...
<div id="think_page_trace_open" style="text-align: right;overflow:hidden;position:fixed;bottom:0;right:0;color:#000;"><img width="30" style="cursor:pointer;background:#fff;border-radius:5px 0 0;" src="data:image/png;base64,<?php echo App::logo() ?>"></div>
