...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbIbase.class.php';

class Lib_Think_Db_Driver_DbIbaseTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbIbase
     * @access protected
    ...
    protected function setUp()
    {
        if (!extension_loaded('interbase')) {
            $this->markTestSkipped('interbase extension not loaded');
        } else {
            $this->object = new DbIbase();
        }
    }
