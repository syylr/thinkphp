...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbPgsql.class.php';

class Lib_Think_Db_Driver_DbPgsqlTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbPgsql
     * @access protected
