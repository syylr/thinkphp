...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbMysqli.class.php';

class Lib_Think_Db_Driver_DbMysqliTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbMysqli
     * @access protected
