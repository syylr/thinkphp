...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbMysql.class.php';

class Lib_Think_Db_Driver_DbMysqlTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbMysql
     * @access protected
