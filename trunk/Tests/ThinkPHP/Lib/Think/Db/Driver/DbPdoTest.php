...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbPdo.class.php';

class Lib_Think_Db_Driver_DbPdoTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbPdo
     * @access protected
