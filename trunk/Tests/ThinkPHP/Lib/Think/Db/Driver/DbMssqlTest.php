...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbMssql.class.php';

class Lib_Think_Db_Driver_DbMssqlTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbMssql
     * @access protected
    ...
    /**
     * @todo Implement testMssql_insert_id().
     */
    public function testMssql_insert_id() {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
          'This test has not been implemented yet.'
        );
