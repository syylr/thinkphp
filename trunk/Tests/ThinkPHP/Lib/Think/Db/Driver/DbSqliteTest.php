...
require_once THINK_PATH . '/Lib/Think/Db/Driver/DbSqlite.class.php';

class Lib_Think_Db_Driver_DbSqliteTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    DbSqlite
     * @access protected
