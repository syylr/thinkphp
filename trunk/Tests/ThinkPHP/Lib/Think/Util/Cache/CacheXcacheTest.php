...
require_once THINK_PATH . '/Lib/Think/Util/Cache/CacheXcache.class.php';

class Lib_Think_Util_Cache_CacheXcacheTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    CacheXcache
     * @access protected
