...
require_once THINK_PATH . '/Lib/Think/Util/Cache/CacheShmop.class.php';

class Lib_Think_Util_Cache_CacheShmopTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    CacheShmop
     * @access protected
