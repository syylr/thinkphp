...
{//类定义开始
    ...
    function _resultset($attr,$content) {
        return $this->_iterate($attr,$content);
    }
    ...
    function _subeach($attr,$content)
    {
     ...
     * @return string|void
     +----------------------------------------------------------
     */
    function _compare($attr,$content,$type='eq')
    {
