...
// +----------------------------------------------------------------------+
// $Id: TagLib.class.php 11 2007-01-04 03:57:34Z liu21st $
 ...
 *
 * 如果要指定标签库解析类，可以使用
 * <taglib name='cx'  class='FCS.Template.TagLib.TagLib_cx' />
 ...
 * 应该写成 <vo name='user' value='id' />
 +------------------------------------------------------------------------------
 * @author    liu21st <liu21st@gmail.com>
 * @version   $Id: TagLib.class.php 11 2007-01-04 03:57:34Z liu21st $
 +------------------------------------------------------------------------------
 */
