...
// +----------------------------------------------------------------------+
// $Id: TagLib_Html.class.php 11 2007-01-04 03:57:34Z liu21st $
 ...
 * @author     liu21st <liu21st@gmail.com>
 * @version    $Id: TagLib_Html.class.php 11 2007-01-04 03:57:34Z liu21st $
 +------------------------------------------------------------------------------
 */
import('FCS.Template.TagLib');
...
{//类定义开始
    ...
    function _list($attr) 
    {
        ...
        if(!empty($checkbox) && 'TRUE'==strtoupper($checkbox)) {//如果指定需要显示checkbox列
