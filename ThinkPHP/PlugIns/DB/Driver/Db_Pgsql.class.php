...
// +----------------------------------------------------------------------+
// $Id: Db_Pgsql.class.php 11 2007-01-04 03:57:34Z liu21st $
 ...
 * @package   Db
 * @author    liu21st <liu21st@gmail.com>
 * @version   $Id: Db_Pgsql.class.php 11 2007-01-04 03:57:34Z liu21st $
 +------------------------------------------------------------------------------
 */
Class Db_Pgsql extends Db{
    ...
    Function connect() {
        if ( !$this->linkID ) {
            ...
            @pg_query( $this->linkID,"SET NAMES '".DB_CHARSET."'");
