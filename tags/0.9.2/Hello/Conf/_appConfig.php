...
define('WEB_TITLE','Hello,World!'); 
define('TMPL_DIR','Tpl'); 
define('TMPL_PATH',WEB_ROOT.'/Hello/Tpl/'); 
define('HTML_PATH',WEB_ROOT.'/Hello/'.HTML_DIR.'/'); //
define('DEBUG_MODE',true); 
define('WEB_LOG_RECORD',false); 
